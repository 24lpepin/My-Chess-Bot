...
class GameState:
    def __init__(self):
        ...
        self.move_log = []
        self.board_log = [self.board_to_string()]
        self.white_king_location = (7, 4)
        self.black_king_location = (0, 4)
        self.checkmate = False
        self.stalemate = False
        self.is_three_move_repetition = False
    ...
    def make_move(self, move):
        ...
        #Update board log
        self.board_log.append(self.board_to_string())
    ...
    def get_valid_moves(self):
            ...
            if len(self.checks) == 1:  # only 1 check, block the check or move the king
                ...
                if piece_checking[1] == "N":
                    ...
                    for i in range(1, 8):
                        ...
                        if (valid_square[0] == check_row
                                and valid_square[1] == check_col):  # once you get to piece and check
                            break
        ...
        if self.three_move_repetition():
            self.is_three_move_repetition = True
        else:
            self.is_three_move_repetition = False
    ...
    def three_move_repetition(self):
        """
        Helper method to determine if a board state appears 3 times in the game
        """
        counts = Counter(self.board_log)
...
class Move:
    ...
    def get_chess_notation(self):
        ...
        if self.is_enpassant_move:
            return (self.get_rank_file(self.start_row, self.start_col)[0] + "x" +
                    self.get_rank_file(self.end_row, self.end_col) + " e.p.")
        ...
        # TODO Disambiguating moves (checks, checkmate, if two pieces can move to the same square, which one moves?)
